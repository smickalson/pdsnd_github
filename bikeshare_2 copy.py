...
def get_filters():
    ...
    while True:
      city = input("\nWhich city would you like to see? New York City, Chicago or Washington?\n").title()
      city = city.lower()
...
def station_stats(df):
    ...
    print('\nMost Commonly used combination of start station and end station:', Start_Station, " & ", End_Station)
